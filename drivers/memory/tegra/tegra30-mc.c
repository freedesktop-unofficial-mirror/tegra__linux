...
static const struct of_device_id tegra30_periph_matches[] = {
	{ }
};

static const struct tegra_smmu_group_init tegra30_smmu_groups[] = {
	{ 0, "peripherals", tegra30_periph_matches },
};
...
static const struct tegra_smmu_soc tegra30_smmu_soc = {
	.groups = tegra30_smmu_groups,
	.num_groups = ARRAY_SIZE(tegra30_smmu_groups),
