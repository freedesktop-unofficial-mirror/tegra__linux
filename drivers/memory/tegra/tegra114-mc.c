...
static const struct of_device_id tegra114_periph_matches[] = {
	{ }
};

static const struct tegra_smmu_group_init tegra114_smmu_groups[] = {
	{ 0, "peripherals", tegra114_periph_matches },
};
...
static const struct tegra_smmu_soc tegra114_smmu_soc = {
	.groups = tegra114_smmu_groups,
	.num_groups = ARRAY_SIZE(tegra114_smmu_groups),
